...
export function MobileSlider(props: Props) {
  ...
  function mhandlePlayBack(value: any) {
    if (audio) {
  ...
  return (
    <SliderPrimitive.Root
      ...
      step={1}
      aria-label="value"
      className="relative flex h-2 w-full touch-none items-center"
      onValueChange={(value) => mhandlePlayBack(value)}
    >
